...
export class WebCommons {
    ...
    //Common method to verify the element value is not visible
    async verifyElementIsNotVisible(selector: string) {
        await expect(this.element(selector)).not.toBeHidden();
    }
}

// This line allows you to use these steps in your actual test file
export default WebCommons